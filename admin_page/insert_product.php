...
include('../admin_page/product_images/');
...
if (isset($_POST['insert_product'])) {
    ...
    if (
        $product_title == '' or $product_description == '' or $product_keywords == '' or $product_categories == '' 
        ...
        $insert_products = "INSERT INTO `products` (product_title, product_description,
            ...
            '$product_keywords', '$product_categories', '$product_brands', '$product_image1',
